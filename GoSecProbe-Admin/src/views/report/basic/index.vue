    ...
    <template v-else>
      ...
      <a-card class="general-card report-footer" style="margin-top: 16px">
        <div class="footer-content">
          ...
          <span>本报告由 GoSecProbe 安全扫描系统自动生成 · {{ new Date().toLocaleString('zh-CN') }}</span>
        </div>
      </a-card>
    </template>
  </div>
...
<div class="page">
  ...
  <div class="footer">本报告由 GoSecProbe 安全扫描系统自动生成 &nbsp;&middot;&nbsp; ${new Date().toLocaleString('zh-CN')}</div>
</div>
</body></html>`
}
